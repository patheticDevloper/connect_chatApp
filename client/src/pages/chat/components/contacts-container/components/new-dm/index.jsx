      ...
      return (
        ...
        >
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1 bg-[#1c1d25] md:flex flex-col justify-center  items-start duration-1000 transition-all  pt-10 md:pt-0">
              <Lottie
              ...
              />
              <div
                className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center w-full
     "
              >
