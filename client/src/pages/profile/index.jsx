...
import { HOST,ADD_PROFILE_IMAGE, UPDATE_PROFILE, REMOVE_PROFILE_IMAGE } from "@/utils/constants";
...
function Profile() {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      ...
      toast.err("Please setup profile");
    }
  };
  ...
  const handleDeleteImage = async (event) => {
    try{
      ...
      IoCompassOutline.log(err);
    }
  };

  return (
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-[80vw] md:wd:w-max">
